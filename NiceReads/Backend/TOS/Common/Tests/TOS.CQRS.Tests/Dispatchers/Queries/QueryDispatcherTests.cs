    ...
    public class QueryDispatcherTests
    {
        ...
        public void When_ExecutingQuery_ShouldFindHandler_AndDeliverExecution()
        {
            ...
            _executionHandlerProvider
                .Setup(p => p.GetHandlerFor<IQueryHandler<IQuery<string>, string>>(true))
                .Returns(handler.Object);

            _handlerExecutor
                .Setup(e => e.Execute<IQuery<string>, IQueryHandler<IQuery<string>, string>, string>(handler.Object, query.Object))
            ...
            _handlerExecutor.Verify(e => e.Execute<IQuery<string>, IQueryHandler<IQuery<string>, string>, string>(handler.Object, query.Object));
        }
        ...
        public async Task When_ExecutingAsyncQuery_ShouldFindHandler_AndDeliverExecution()
        {
            ...
            _executionHandlerProvider
                .Setup(p => p.GetHandlerFor<IAsyncQueryHandler<IAsyncQuery<string>, string>>(true))
                .Returns(handler.Object);

            _handlerExecutor
                .Setup(e => e.ExecuteAsync<IAsyncQuery<string>, IAsyncQueryHandler<IAsyncQuery<string>, string>, string>(handler.Object, asynQuery.Object))
            ...
            _handlerExecutor.Verify(e => e.ExecuteAsync<IAsyncQuery<string>, IAsyncQueryHandler<IAsyncQuery<string>, string>, string>(handler.Object, asynQuery.Object));
        }
